...
<!-- envman-skill-lock: version=0.1.8 source=src/envman/cli.py -->
...
- [CLI reference](https://github.com/CruxExperts/envman/blob/v0.1.8/docs/guides/cli.md)
- [Encrypted backups and migration](https://github.com/CruxExperts/envman/blob/v0.1.8/docs/guides/backups-and-migration.md)
- [Terminal UI guide](https://github.com/CruxExperts/envman/blob/v0.1.8/docs/guides/tui.md)
- [Storage and shell loading](https://github.com/CruxExperts/envman/blob/v0.1.8/docs/reference/storage-and-shell-loading.md)
- [Installation sources and updates](https://github.com/CruxExperts/envman/blob/v0.1.8/docs/reference/install-source-and-updates.md)
